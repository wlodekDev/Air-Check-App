    ...
    render(){
        ...
        return <div className='mainWrapper'>
            <div className='ribbon'>
                <a href="https://github.com/wlodekDev/wlodekDev.github.io" target='_blank'><img style={{position: 'absolute', top: '0', right: '0', border: '0'}} src="https://s3.amazonaws.com/github/ribbons/forkme_right_gray_6d6d6d.png" alt="Fork me on GitHub"/></a>
            </div>
